...
interface SvgRefreshProps extends SVGProps<SVGAElement> {}

export const SvgRefresh = (props: SvgRefreshProps) => {
  return (
    <svg
      {...props}
      height="24px"
